    ...
    <div className='login'>
      <div className="card">
        ...
        <div className="right">
          <h1>Login</h1>
          <form>
            <input type="text" placeholder="Test Username: Jane Doe" name="username" onChange={handleChange}/>
            <input type="password" placeholder="Test Password: 12345" name="password" onChange={handleChange} />
